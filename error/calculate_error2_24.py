...
for target in ['avgcpu', 'avgmem']:
    ...
    for file in "abcdefgh":
        ...
        for stl in ['seasonal', 'trend', 'residual']:
            ...
            df = pd.read_csv(f'../STL-iTransformer/24/experiment1/results/{target}/{stl}/gc19_{file}-{target}-Forecast.csv')
        ...
        plt.ylabel(f'{target}')
        plt.legend()
        plt.savefig(f"../STL-iTransformer/24/experiment1/{file}-{target}.png")
